...
#funções:
    ...
    def escolha(self, event=None):
        if self.tipo_de_relatorio.get() == 'PERSONALIZADO':
            ...
            self.estado_relatorio_entry = tk.Combobox(self.conteudo_lateral,values=Destinos)
            ...
            self.check1.bind('<Button-1>', self.bind_checkbutton)
            ...
            self.contrato_relatorio_entry = tk.Combobox(self.conteudo_lateral,values=conexao_banco.busca_informacoes_personalizado(conexao_banco))
            ...
            self.check2.bind('Button-1', self.bind_checkbutton)
            ...
            self.produto_relatorio_entry = tk.Combobox(self.conteudo_lateral, values= ds_produtos)
            ...
            self.check3.bind('Button-1', self.bind_checkbutton)
        ...
        return self.retorno_relatorio

    def bind_checkbutton(self, event=None):
        ...
        if self.valida_estado.get() == 0:
            ...
            self.check2.config(state='active')
            print(self.valida_estado.get())

        # # se : produto por estado
        ...
        # elif self.valida_contrato.get() == 0:
        #     self.check3.config(state='active')
